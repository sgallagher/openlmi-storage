...
"""Python Provider for Cura_PartitionBasedOnLocalDiskExtent

Instruments the CIM class Cura_PartitionBasedOnLocalDiskExtent
...
class Cura_PartitionBasedOnLocalDiskExtent(CIMProvider2):
    """Instrument the CIM class Cura_PartitionBasedOnLocalDiskExtent 
    ...
    def enum_instances(self, env, model, keys_only):
        ...
        for partition in storage.partitions:
            ...
            model['Antecedent'] = pywbem.CIMInstanceName(classname='Cura_LocalDiskExtent',
                    namespace=CURA_NAMESPACE,
...
## end of class Cura_PartitionBasedOnLocalDiskExtentProvider
    
## get_providers() for associating CIM Class Name to python provider class name
    
def get_providers(env): 
    initAnaconda(False)
    cura_partitionbasedonlocaldiskextent_prov = Cura_PartitionBasedOnLocalDiskExtent(env)  
    return {'Cura_PartitionBasedOnLocalDiskExtent': cura_partitionbasedonlocaldiskextent_prov} 
