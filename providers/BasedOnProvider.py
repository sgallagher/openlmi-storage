...
class BasedOnProvider(CIMProvider2):
    ...
    def enumerateDevices(self):
        """
            ...
            DeviceProvider.getBaseDevices of the DependentDevice.
        """
        return []
    ...
    def enum_instances(self, env, model, keys_only):
        ...
        for device in self.enumerateDevices():
            ...
            for base in provider.getBaseDevices(device):
    ...
    def get_instance(self, env, model, device = None, base = None):
        ...
        deviceProvider = self.manager.getProviderForName(model['Dependent'])
        if not (base in deviceProvider.getBaseDevices(device)):
